...
export const translations = {
  ja: {
    ...
    rules: {
      ...
      roles: [
        { name: 'ピンゾロ', dice: '1-1-1', desc: '最強役' },
        { name: 'シゴロ', dice: '4-5-6', desc: '次点の高役' },
        { name: '6アラシ〜2アラシ', dice: 'N-N-N', desc: 'ゾロ目。数字が大きいほど強い' },
  ...
  en: {
    ...
    rules: {
      ...
      roles: [
        { name: 'Pinzoro', dice: '1-1-1', desc: 'Best hand' },
        { name: 'Shigoro', dice: '4-5-6', desc: 'Second best hand' },
        { name: '6 Storm – 2 Storm', dice: 'N-N-N', desc: 'Three of a kind. Higher number wins' },
